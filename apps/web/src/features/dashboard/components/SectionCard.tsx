...
interface SectionCardProps {
  title: string;
  /** İsteğe bağlı sağ üst alan (badge, "Tümü" linki vb.) */
  rightSlot?: ReactNode;
  /** Header altı küçük açıklama */
  description?: string;
  children: ReactNode;
  className?: string;
}
...
/**
 * Dashboard alt panelleri için ortak çerçeve (Saatlik Ciro, Ödeme Dağılımı,
 * En Çok Satan, Son Siparişler, Kapanan Siparişler). Glassmorphism + soft shadow.
 */
