...
/**
 * ADR-015 §3.3 — GET /reports/kpi/average-bill
 * SUM(orders.total_cents) / COUNT(*)  WHERE status='paid' bugün.
 * sampleSize=0 → averageBillCents=0 (frontend "—" gösterir).
 * Banker's rounding değil; integer division (Math.floor).
 */
