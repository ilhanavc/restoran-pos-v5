 ...
 *
 * Migration NNN review needed: kategori×product×order_item×order chain için
 * ek indeks gerekmiyor (mevcut tenant_id + status + created_at indeksleri yeter);
 * ölçüm gerekirse ayrı PR ile EXPLAIN ANALYZE.
 */
  ...
  router.get(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const payload = CategorySalesResponseSchema.parse({
          categories,
