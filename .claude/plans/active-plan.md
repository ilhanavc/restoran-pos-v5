...
**main HEAD:** `d7a3972` (S86 toplam 14 PR #291-304) · **prod code == `ad14c5a`** (#300/#302/#303 Caller ID API fix'leri deploy'lu; health ✓)
**▶ SIRADAKİ (Phase 5 kalan — yalnız CUTOVER; [USER]/[OPS]): kasiyer istasyonu + cutover günü (kasa agent Zadig→WinUSB + codepage-scan 61 + order_no 1'den; ⛔ Adisyo yaşarken YASAK; runbook `docs/ops/cutover-gunu-runbook.md`) · 2-4 hafta → Adisyo iptali = pilot bitiş. ✅ A1/A2/A3/**A5 CALLER ID CANLI**/A6/A7. ⏸ ERTELENDİ: A4 hukuki tesis (paket hazır) + KDS (kağıt fiş yeter). Detay: `.claude/plans/session-87-kickoff.md`.**
