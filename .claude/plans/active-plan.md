...
**(0) 🔥 ÜRÜN SAHİBİ 11-MADDE EKSİK LİSTESİ (3 gün canlı kullanım) → `session-105-backlog.md`.** Öncelik: P0 (4 mobil-hızlıöde-fiş-gecikme/spooler · 11 mobil-iki-aşamalı-kaydet · 7 web-iki-aşamalı-kaydet) · P1 (9 paket-kişi-butonu · 8 masa-taşıma-sıralama · 6 caller-popup-tekrar · 5 split-öde-kombinasyon) · P2 (2 mobil-ciro · 3 web-açık-tutar · 10 kalem-taşıma · 1 logo). ADR gerekli: 1/2/7/10/11. **Her madde ayrı PR + test + kâğıt/cihaz smoke.**
...
| A7 | Personel eğitimi + kağıt-fallback 1-sayfa şablonu | [USER] ✅ | ✅ **TAMAMLANDI** — şablon (`go-live-kagit-fallback-ve-egitim.md`) hazır + eğitim [USER] tarafından yapıldı. Cutover 2026-07-24'te tamamlandı, sistem canlı; belge artık süregelen operasyon rehberi (Bölüm 1 kağıt fallback kasada asılı) |
