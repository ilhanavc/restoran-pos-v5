...
- [ ] Caller ID **opsiyonel** — hazırsa kur (`caller-bridge-kurulum-smoke.md`), değilse cutover'ı bloklamaz.
...
- [ ] **Codepage teyidi:** kasa fişi ESC t **61** üretir (ADR-004 Amd3, #282 prod'da — ama **`Doğrulanmamış`**). `codepage-scan.ps1` ile ampirik bas → Türkçe (ç/ğ/ş/ı/ö/ü) doğru mu? Yanlışsa doğru sayfayı bul → `CODEPAGE_CP857_PAGE61` tek-satır fix + deploy.
...
*Taslak — Session 86 (2026-07-07). Cutover'a yakın kesinleştirilecek.*
