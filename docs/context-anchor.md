...
- **Phase:** 1 ✅, 1.5 ✅, 2 Sprint 0 ✅, 2 Sprint 1 ✅, 2 Sprint 2 ✅, **2 Sprint 3a (ABAC unblock + CI gating)** ✅ KAPANDI. **Sıradaki: Sprint 3b** (Görev 17 Users CRUD + Görev 18 Products/Variants). **3 blocker durumu:** ADR-002 §10 amendment ✅ merged | Görev 18 ADR-X bekliyor | `permissions.ts` plan-kod drift Sprint 3b plan'ında resolve.
