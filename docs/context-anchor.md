...
- **Phase:** 1 ✅, **Phase 1.5** ✅, **Phase 2 Sprint 0** ✅, **Phase 2 Sprint 1** ✅, **Phase 2 Sprint 2 (GET endpoint'leri)** ✅ KAPANDI. **Şu an: Phase 2 Sprint 3a (Görev 14 — migration 005 PR review).** Sprint 3 plan PR #22 (squash `ec5eae9`) + ADR-003 §14.1.B.3 Phase-conditional enforcement amendment PR #23 (squash `b7afacc`) merged. Sprint 3 → 3a (ABAC unblock: migration 005 + POST hotfix + ABAC enable) + 3b (admin CRUD: Users + Products/Variants) bölündü. KDS Sprint 4'e ertelendi.
