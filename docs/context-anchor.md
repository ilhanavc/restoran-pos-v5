...
- **Phase:** 1 ✅, 1.5 ✅, 2 Sprint 0 ✅, 2 Sprint 1 ✅, 2 Sprint 2 ✅, **2 Sprint 3a (ABAC unblock + CI gating)** ✅ KAPANDI, **2 Sprint 3b (Users CRUD + ADR §8.6 amendment + Products/Variants CRUD)** ✅ KAPANDI. **Sıradaki: Phase 2 charter drift cleanup** — Categories full CRUD + Socket.IO realtime altyapısı + Web UI 7 ekran + E2E Playwright suite (charter Phase 2 line 160-164 kapsamı active-plan'de yarı yarıya, plan revizyonu sprint'lere böler). **Sprint 3b ana keşif (RESOLVED PR #36):** ADR-003 §8.6 `price_delta_cents` semantik amendment (signed/negatif). **Açık kritik borç:** charter Phase 2 drift (Sprint 3b kapanışı sonrası plan yeniden yapılandırılır).
...
- **Sıradaki:** **Phase 2 charter drift cleanup PR** — active-plan vs charter Phase 2 drift düzeltmesi (charter line 160-164: Categories full CRUD + Socket.IO realtime altyapısı + Web UI 7 ekran [login/ana sayfa/masa yönetimi/menü editörü/kullanıcı yönetimi/salon bölgeleri/işletme ayarları] + E2E Playwright smoke suite — sprint'lere böl). KDS+POST /payments active-plan "Sprint 4" → charter Phase 3 Sprint 1 numaralandırması düzeltilir, ADR-008 amendment "Sprint 4 KDS" referansları güncellenir. ADR-007 (rate limiting) Phase 2 ortasında.
- **Çalıştırma:**
