...
4. **tz/store-date UTC** (Blok 7 R7-TZ ailesi — rapor sınırları UTC, İstanbul store-date kayması): reports gün-sınırı yanlış hesaplayabilir. **Tek yardımcı** (store-date IANA-aware). MVP-fix.
