...
| GUV-6 | Access token 30dk iptal edilemez | ✅ Dokümante edildi #TBD2 (ADR-002 §3'e açık "kabul edilmiş risk" notu: stateless JWT TTL içinde tekil revoke edilemez; azaltım kısa-TTL + refresh RTR revoke + logout; anlık-revoke ihtiyacı → v5.1). Kısa-TTL bilinçli; kod değişikliği yok. |
