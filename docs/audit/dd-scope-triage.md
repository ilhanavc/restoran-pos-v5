...
| OPS-5 | Yedek başarı alarmı yok (sessiz yedeksizlik) | YÜKSEK | S | Canlı para/sipariş. Timer/rclone bozulursa ilk fark ediliş = restore anı. Dead-man's-switch + son-yedek-yaşı alarmı. | ✅ Kapandı (ADR-040; pg-backup.sh healthchecks.io dead-man's-switch, fail-safe; aktivasyon: HEALTHCHECK_URL [USER]) |
